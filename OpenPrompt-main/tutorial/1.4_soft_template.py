...
if args.dataset == "boolq":
    ...
    scriptformat = "txt"
    max_seq_l = 256 # this should be specified according to the running GPU's capacity
...
# print(list(prompt_model.plm.named_parameters()))
# print(list(prompt_model.template.named_parameters()))
