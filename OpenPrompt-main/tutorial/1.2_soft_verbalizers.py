...
dataset = {}
dataset['train'] = AgnewsProcessor().get_train_examples("/Work21/2023/zhuangning/code/OpenPrompt-main/OpenPrompt-main/datasets/TextClassification/agnews")
...
dataset['test'] = AgnewsProcessor().get_test_examples("/Work21/2023/zhuangning/code/OpenPrompt-main/OpenPrompt-main/datasets/TextClassification/agnews")
